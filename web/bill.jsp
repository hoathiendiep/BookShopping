<%-- 
    Document   : bill
    Created on : Mar 29, 2020, 1:21:20 PM
    Author     : Lenovo
--%>
                                                                ...
                                                                <form action="bill" method="post">
                                                                    <div class="row">
                                                                        <div class="col-50">
                                                                            ...
                                                                            <input type="text" id="fname" name="fname" value="${sessionScope.user.firstname}" required>
                                                                                <label for="lname"><i class="fa fa-user"></i>Họ</label>
                                                                                <input type="text" id="lname" name="lname" value="${sessionScope.user.lastname}" required>   
                                                                                    <label for="email"><i class="fa fa-envelope"></i> Email</label>
                                                                                    <input type="text" id="email" name="email" value="${sessionScope.user.email}" pattern="^[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" required>
                                                                                        <label for="phone"><i class="fa fa-phone"></i> Số điện thoại</label>
                                                                                        <input type="text" id="email" name="phone" value="${sessionScope.user.phone}" pattern="^\d{10}$" required>
                                                                                            <label for="adr"><i class="fa fa-address-card-o"></i> Địa chỉ</label>
                                                                                            <input type="text" id="adr" name="address" value="${sessionScope.user.address}">
                                                                                                </div>
                                                                                                </div>
                                                                                                    ...
                                                                                                    <div class="col-25">
                                                                                                        <div class="container">
                                                                                                            <h4>Giỏ Hàng <span class="price" style="color:black"><i class="fa fa-shopping-cart"></i></span></h4>
                                                                                                                ...
                                                                                                                <p><a href="#">${s.product.name}(${s.quantity})</a> <span class="price"><fmt:formatNumber value = "${s.product.price * s.quantity}" minFractionDigits = "3"/> VND</span></p>    
                                                                                                            </c:forEach>
                                                                                                            <hr>
                                                                                                                <p>Tổng cộng: <span class="price" name="total" style="color:black"><b><fmt:formatNumber value = '<%=((ShoppingCart) session.getAttribute("cart")).total()%>' minFractionDigits = "3"/> VND</b></span></p>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                    </div>
                                                                                                    <div class="footer">
